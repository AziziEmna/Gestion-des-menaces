...
<body>
    <form method="post" action="/ProjetPPP/save">
<div class="wrapper">
                            ...
                            <div class="content table-responsive table-full-width">
                              ...
                              <p class="title" id="demo"></p>
                                 ...
                                 <p class="double" >
                                     ...
                                     <% 
                                      String b = (String) request.getAttribute("rapport");
                                     out.print(b);
                                     %>
                            ...
                            <div class="content">
                                <div class="author">
                                     <a href="#">
                                         ...
                                         <br><br> <br>
                                         <font size="4" color="#7F60CF">  <h4 class="title" > 
                                             <Strong>You have chosen </strong> <br /></h4>
                                         <div align="left">
                                             <br>
                                             <br> <br>
                                             ...
                                             <center>
                                                 ...
                                                 <strong>
                                                     ...
                                                     <%
                                     String k = (String) request.getAttribute("type");
                                     out.print(k);
                                     %>
                                                 ...
                                                 <br><br>
                                                 <a  id="button" href="${pageContext.request.contextPath}/ppp/dashboard.jsp" class="myButton "> Return </a></center>   </strong>
  <br><br>
  
  
                                                                       <script>
document.getElementById("button").onclick = function() {
   alert("Your Report Has Been Saved  ! Return to Dashboard ");
};
</script>
                </div> 
                            </a><br>
